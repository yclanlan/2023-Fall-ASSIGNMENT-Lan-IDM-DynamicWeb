...
export const RECIPE = {
    ...
    description:
      'The simple stir-fried water spinach with garlic tastes refreshing and delicious. Water spinach is rich in fiber, the antibacterial effect of garlic and the spiciness of chili pepper are combined together. Super fast serving 😆',
    ...
    instructions: [
      'After applying a coat of oil to the pan, add sliced garlic and chili. Sauté until they become tender and fragrant.',
  ...
  export const RECIPE_LIST = [
    ...
    ingredients: [
      {name:'water spinach',measure:'some'},
      {name:'garlic',measure:'a little'},
      {name:'Chillies',measure:'a little'},
      {name:'salt',measure:'a little'},
    ],
